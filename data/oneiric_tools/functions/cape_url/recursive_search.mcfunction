#34 67 65 80 69 34 32 58 32 123 10 32 32 32 32 32 32 34 117 114 108 34 32 58 32 34 32
function oneiric_tools:cape_url/next_search
...
execute if score #matches oneiric_var matches 4 store success score #success oneiric_var if score #byte oneiric_var matches 69
execute if score #matches oneiric_var matches 3 store success score #success oneiric_var if score #byte oneiric_var matches 80
execute if score #matches oneiric_var matches 2 store success score #success oneiric_var if score #byte oneiric_var matches 65
execute if score #matches oneiric_var matches 1 store success score #success oneiric_var if score #byte oneiric_var matches 67
...
execute if data storage oneiric_tools:head data.out[1] unless score #matches oneiric_var matches 26.. run function oneiric_tools:cape_url/recursive_search