...
function oneiric_tools:skin_url/next_search
...
execute if data storage oneiric_tools:head data.out[0] unless score #matches oneiric_var matches 26.. run function oneiric_tools:skin_url/recursive_search 