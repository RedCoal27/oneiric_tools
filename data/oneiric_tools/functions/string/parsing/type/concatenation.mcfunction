...
execute store result score #length2 oneiric_var run data get storage oneiric_tools:string temp.value2
scoreboard players operation #length oneiric_var += #length2 oneiric_var
