...
data modify block -29999999 4 74063 front_text.messages[0] set value '[{"text":"data modify storage oneiric_tools:string output set string storage oneiric_tools:string output 0 "},{"score":{"objective":"oneiric_var","name":"#length"}}]'
data modify entity 4eeb080d-c17f-4b5a-9890-8191648e267e CustomName set from block -29999999 4 74063 front_text.messages[0]
