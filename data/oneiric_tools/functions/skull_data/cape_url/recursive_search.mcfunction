...
execute if data storage oneiric_tools:head data.out[1] unless score #matches oneiric_var matches 26.. run function oneiric_tools:skull_data/cape_url/recursive_search